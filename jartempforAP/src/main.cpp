...
void armlower(){
  ladybrown.spinFor(reverse, 1.75, sec);
}
event Event = event(resetarm);
event armdown = event(armlower);
...
void autonomous(void) {
  ...
  switch(current_auton_selection){  
    case 0: //blueneg (forward = 30)
      ...
      Intake.stop();
      IntakeLift.set(true);
      chassis.drive_distance(23, 72, 6, 11);
    ...
    case 1: //redpos
      ...
      // chassis.set_turn_exit_conditions(1, 300, 1250);
      // chassis.set_swing_exit_conditions(1, 300, 1000);
      // chassis.drive_distance(-25, 0, 11, 11);
      // chassis.turn_to_angle(330);
      // chassis.drive_distance(-15.5, 330, 11, 11);
      // Pneumatic.set(true);
      // chassis.drive_distance(3.1, 330, 11, 11);
      // chassis.turn_to_angle(30);
      // Intake.spin(forward);
      // chassis.drive_distance(16, 30, 11, 11);
      // wait(1, sec);
      // Intake.spin(reverse);
      ...
      // wait(0.1, sec);
      // IntakeLift.set(true);
      // chassis.drive_distance(-21, 269, 11, 11);
      // Pneumatic.set(true);
      // chassis.turn_to_angle(48.5);
      // chassis.drive_distance(21, 48.5, 5, 11);
      // Intake.spin(forward);
      // wait(0.05, sec);
      // IntakeLift.set(false);
      // wait(1.75, sec);
      ...
      // Pneumatic.set(false);
      // chassis.drive_distance(20, 170, 6, 11);
      Intake.spin(forward);
      break;
    case 2: //bluepos
      chassis.set_drive_exit_conditions(9, 200, 1750);
      chassis.set_turn_exit_conditions(1, 300, 1250);
      chassis.set_swing_exit_conditions(1, 300, 1000);
      chassis.drive_distance(-30, 0, 7, 11);
      Pneumatic.set(true);
      wait(0.5, sec);
      Intake.spin(forward);
      wait(0.5, sec);
      chassis.turn_to_angle(298);
    ...
    case 4: //redpos
      ...
      Intake.stop();
      IntakeLift.set(true);
      chassis.drive_distance(24, -72, 6, 11);
      IntakeLift.set(false);
      Intake.spin(forward);
      wait(1.5, sec);
      chassis.turn_to_angle(-215);
